...
export const testcases: TestCase[] = [
  ...
  {
    inputs: bundle,
    params: { offset: 10, length: 10, html: true },
    result: results[15],
  },
  { inputs: bundle, params: { display_offset: 10 }, result: results[16] },
  {
    inputs: bundle,
    params: { display_offset: 10, offset: 10, length: 10 },
    result: results[17],
  },
  {
    input:
      _00 + _00 + _08 + _40 + _53 + _00 + _0000 + _5100 + _0000 + _5100 + _0000,
    params: {},
    result:
      "00000000: 0000 0840 5300 0000 5100 0000 5100 0000  ...@S...Q...Q...\n",
  },
  // #20
  {
    input: str3,
  ...
  // endianness
  {
    ...
    result: "00000000: 0201 0f03                                ....\n",
  },
  // alternative radix
  {
    input: arr,
    params: { radix: 10, format: "twos" },
    result:
      "00000000: 001 002 003 015                                                    ....\n",
  },
  // suppression of non-printable characters
  {
    input: [0x68, 0x65, 0x6c, 0x6c, 0x6f, 0xd2, 0x77, 0x6f, 0x72, 0x6c, 0x64],
    params: { format: "twos", html: true, extendedChs: true },
    result:
      "<div class='hexy'>\n" +
  ...
  // #30
  {
    ...
    params: { format: "twos" },
    result:
      "00000000: 68 65 6c 6c 6f d2 77 6f 72 6c 64                   hello.world\n",
  },
  {
    input: [0x68, 0x65, 0x6c, 0x6c, 0x6f, 0xd2, 0x77, 0x6f, 0x72, 0x6c, 0x64],
    params: { format: "twos", extendedChs: true },
    result:
      "00000000: 68 65 6c 6c 6f d2 77 6f 72 6c 64                   hello" +
      "\u00d2" +
      "world\n",
  },
];
